...
In returning to clojure, there was one library that I wanted to check out and that one is [honeysql](https://github.com/seancorfield/honeysql). HoneySQL is a library where you can create a clojure map and use the `sql/format` function to turn that map into a raw sql query.
